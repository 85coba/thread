    ...
    >
        ...
        <div class="navbar-menu is-hidden-desktop mobile-menu" :class="{ 'is-active': isMobileMenuActive }">
            <div class="navbar-end" @click="isMobileMenuActive = false">
                ...
                <router-link class="navbar-item" :to="{ name: 'user-page', params: { id: user.id }, query: {type: 'myTweets'}}">
                    <b-icon pack="fab" icon="twitter-square" />
                    <span>My feed</span>
                </router-link>

                <router-link class="navbar-item" :to="{ name: 'user-page', params: { id: user.id }, query: {type: 'likedTweets'}}">
                    <b-icon pack="fab" icon="twitter-square" />
                    <span>My liked feed</span>
                </router-link>
