...
Route::prefix('v1')->group(function () {
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::get('/{id}/likers', 'LikeController@getUsersLikedByTweetId');
        });
        ...
        Route::group([
            ...
            Route::put('/{id}/like', 'CommentLikeController@likeOrDislikeComment');
            Route::get('/{id}/likers', 'CommentLikeController@getUsersLikedByCommentId');
        });
    });
});
